    ...
    <footer className="bg-gray-50 dark:bg-gray-900 py-12 mt-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">Alan Turing</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Pioneering computer scientist, mathematician, and logician.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="mailto:alan.turing@example.com" className="text-gray-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-800">
          <p className="text-center text-sm text-gray-600 dark:text-gray-400">
            © {new Date().getFullYear()} Alan Turing. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
